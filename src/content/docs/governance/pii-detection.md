---
title: "PII detection"
description: "Discover NeuralSeek's advanced PII detection, ensuring data privacy by identifying, masking, and managing sensitive information. Customize settings for specific needs and maintain compliance effortlessly."
---
...
![entering PII](/img/governance/pii-detection/credit-card.png)
...
![detecting PII](/img/governance/pii-detection/pii_image_002.png)
...
![masking PII](/img/governance/pii-detection/pii_image_003.png)
...
![defining pii](/img/governance/pii-detection/pii_image_004.png)
...
![masking PII result](/img/governance/pii-detection/pii_image_005.png)
...
![ignoring pii](/img/governance/pii-detection/pii_image_006.png)

Therefore, when asked about a similar question, notice how dog’s name is now visible as not a PII information:

![ignoring pii result](/img/governance/pii-detection/pii_image_007.png)
