...
description: "Discover how NeuralSeek's Semantic Analytics enhances response accuracy by linking answers to their sources. Explore semantic match scores, color-coded insights, and customizable configurations."
---
...
![what is semantic analytics](/img/governance/semantic-analytics/supported-integrations.png)
...
![why is it important](/img/governance/semantic-analytics/image_002.png)
...
![configuring semantic analytics](/img/governance/semantic-analytics/image_003.png)

:::note[How re-ranking the search result using semantic analysis can be helpful?]
...
![turning on provenance](/img/governance/semantic-analytics/answer_provenance_updated2.png) <!--{: style="width:25%" }-->
...
![scores](/img/governance/semantic-analytics/image_005.png)
...
![kb results](/img/governance/semantic-analytics/image_006.png)
...
![contexts](/img/governance/semantic-analytics/image_007.png)
...
![stump speech](/img/governance/semantic-analytics/image_008.png)
...
![org preference](/img/governance/semantic-analytics/organization-prefs.png)
...
![org preference](/img/governance/semantic-analytics/image_010.png)
...
![kb score and date penalty settings](/img/governance/semantic-analytics/image_011.png)
...
![example high score](/img/governance/semantic-analytics/high-example.png)

**Medium score example**

![example med score](/img/governance/semantic-analytics/medium-example.png)

**Low score example**

![example low score](/img/governance/semantic-analytics/low-example.png)

<!-- STILL TO DOCUMENT ON THIS PAGE:
  - Absorbs the Seek > Semantic Insights dashboard
  - Semantic Distribution — histogram of semantic scores
  - Semantic Quality — composite view of how answers relate to their sources
  - Hallucination Bloom — where the model invents language your documents do not support
  - Question Resolution also appears here
-->
