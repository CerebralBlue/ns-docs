...
1. `bun scripts/agentic/config-slice.ts <runId> --fetch --json` — POSTs `packConfig` on the
   ...
   is expected, not a failure. The file is the restore point cleanup compares against.
