...
The browser profile is logged into `https://console-partners.neuralseek.com/28b3b6870dea779f2681e5cc/`
— a **production** instance. Navigate, open tabs and disclosures, snapshot, screenshot. Never
type, never submit, never click anything whose name suggests it commits (Save, Run, Delete,
Apply…) — the hook refuses those and logs the attempt. A click needs a `ref` from a snapshot
you saved to a file first; the hook checks the ref against that file.
...
Known console facts (verified 2026-09-02): top nav **Home · Neural Config · Seek · KnowledgeBase
...
`https://console-partners.neuralseek.com/28b3b6870dea779f2681e5cc/<page>`.
